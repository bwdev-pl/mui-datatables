...
|**`dragAndDrop`**|object||Option to enabling drag&drop functionality on datatable. `{enabled: bool, scrollableElementQuery: string, callback: function(row, prevRow, nextRow, rowIndex, dragTargetSpotIndex)}`
