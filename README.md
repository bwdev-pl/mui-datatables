...
|**`dragAndDrop`**|object|{enabled: bool, callback: function(rowIndex, prevRow, nextRow, dragTargetSpotIndex)}|Option to enabling drag&drop functionality on datatable.
